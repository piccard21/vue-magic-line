    ...
    export default {
      ...
      methods: {
        ...
        setPrimary(el) {   
          ...
          this.$emit('before-set-primary', this.magicLinePrimary, el)
          this.setPosition(el, this.magicLinePrimary)
          this.$emit('set-primary', this.magicLinePrimary, el)
        ...
        setSecondary(el) { 
          ...
          this.$emit('before-set-secondary', this.magicLineSecondary, el)
          this.setPosition(el, this.magicLineSecondary)
          this.$emit('set-secondary', this.magicLineSecondary, el)
        },
